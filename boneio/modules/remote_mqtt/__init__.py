...
# Enrichment + save-strip hooks live in manager_integration.py — that's the
# sub-module already registered with the ModuleRegistry; keeping the API
# symmetric with expander (where hooks live in __init__.py) would require
# changing where this module self-registers, which is a wider refactor.
